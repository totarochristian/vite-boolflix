<template>
  <div class="w-100 h-100" :class="{'d-none': !store.settings.currentMenuSectionIndexOpened == 1}">
    <MatrixComponent :languageIndex="store.settings.currentLanguageIndex" :endPoint="store.apiSettings.endPoints.film.popular" :title="store.settings.languages[store.settings.currentLanguageIndex].carouselsTitles[0]"/>
